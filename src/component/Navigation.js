...
export default function LabelBottomNavigation(props) {
  ...
  return (
    <BottomNavigation value={value} onChange={handleChange} className={classes.root} showLabels>
      <BottomNavigationAction label="Special Offers" value="recents" icon={<RestoreIcon />} component={Link} to="/" />
      <BottomNavigationAction label="Store Locator" value="favorites" icon={<StoreIcon />} component={Link} to="/store-locator"/>
      <BottomNavigationAction label="Scan" value="nearby" icon={<LocationOnIcon />} component={Link} to="/scan"/>
      <BottomNavigationAction label="ACE Care" value="folder" icon={<Icon>folder</Icon>} component={Link} to="/"/>
